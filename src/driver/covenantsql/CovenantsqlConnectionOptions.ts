 ...
 */
export interface CovenantsqlConnectionOptions extends BaseConnectionOptions, CovenantsqlConnectionCredentialsOptions {

    /**
     * Database type.
     */
    readonly type: "covenantsql";
    ...
    readonly replication?: {
         ...
         */
        readonly master: CovenantsqlConnectionCredentialsOptions;

        /**
         * List of read-from severs (slaves).
         */
        readonly slaves: CovenantsqlConnectionCredentialsOptions[];

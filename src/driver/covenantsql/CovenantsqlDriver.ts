...
import {CovenantsqlQueryRunner} from "./CovenantsqlQueryRunner";
...
import {CovenantsqlConnectionOptions} from "./CovenantsqlConnectionOptions";
import {MappedColumnTypes} from "../types/MappedColumnTypes";
import {ColumnType} from "../types/ColumnTypes";
import {DataTypeDefaults} from "../types/DataTypeDefaults";
import {TableColumn} from "../../schema-builder/table/TableColumn";
import {CovenantsqlConnectionCredentialsOptions} from "./CovenantsqlConnectionCredentialsOptions";
 ...
 */
export class CovenantsqlDriver implements Driver {
     ...
     * Connection options.
     */
    options: CovenantsqlConnectionOptions;
    ...
    constructor(connection: Connection) {
        ...
        this.options = connection.options as CovenantsqlConnectionOptions;
    ...
    createQueryRunner(mode: "master"|"slave" = "master") {
        return new CovenantsqlQueryRunner(this, mode);
    }
     ...
     */
    protected createConnectionOptions(options: CovenantsqlConnectionOptions, credentials: CovenantsqlConnectionCredentialsOptions): Promise<any> {

...
import {CovenantsqlDriver} from "./CovenantsqlDriver";
 ...
 */
export class CovenantsqlQueryRunner extends BaseQueryRunner implements QueryRunner {
    ...
    constructor(driver: CovenantsqlDriver, mode: "master"|"slave" = "master") {
        super();
        this.driver = driver;
